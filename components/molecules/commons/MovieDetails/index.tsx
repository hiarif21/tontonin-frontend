...
const MovieDetails = () => {
  ...
  return (
    <Modal onClickOutside={handleClose} show _ref={refModal}>
      <div className="flex h-full w-full flex-col items-center overflow-y-auto md:bg-slate-900/20 md:p-5 md:backdrop-blur-sm md:dark:bg-slate-100/20">
        <div
          ref={refModal}
          ...
          <div className="flex flex-col gap-5 p-5 pt-0">
            ...
            {/* about movie */}
            <div className="flex flex-col gap-5">
              <h3 className="text-center font-bold sm:text-lg">About Movie</h3>
